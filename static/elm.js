...
var _user$project$Main$getVerticalLines = function (stringBoard) {
	var getColumn = function (index) {
		return A2(
			...
			_elm_lang$core$Array$toList(
				A2(
					_elm_lang$core$Array$map,
					_elm_lang$core$Maybe$withDefault('E'),
					A2(_tortus$elm_array_2d$Array2D$getColumn, index, stringBoard))));
	};
	return A2(
		_elm_lang$core$Array$map,
		getColumn,
		A2(
			_elm_lang$core$Array$initialize,
			_tortus$elm_array_2d$Array2D$columns(stringBoard),
			_elm_lang$core$Basics$identity));
};
var _user$project$Main$getHorizonLines = function (stringBoard) {
		...
		return A2(
			...
			_elm_lang$core$Array$toList(
				A2(
					...
					A2(_tortus$elm_array_2d$Array2D$getRow, index, stringBoard))));
	};
	return A2(
		_elm_lang$core$Array$map,
		getRow,
		A2(
			_elm_lang$core$Array$initialize,
			_tortus$elm_array_2d$Array2D$rows(stringBoard),
			_elm_lang$core$Basics$identity));
};
var _user$project$Main$getDiagonalLines = function (stringBoard) {
	var concatString = F2(
		function (piece, _p0) {
			var _p1 = _p0;
			return A2(
		...
		function (piece, _p2) {
			...
			return {
				...
				_0: A2(
					concatString,
					piece,
					_elm_lang$core$List$unzip(_p3._0)),
				_1: {
					ctor: '::',
					_0: A2(
						concatString,
						piece,
						_elm_lang$core$List$unzip(_p3._1)),
					_1: {ctor: '[]'}
				}
			};
		});
	var getPiece = F2(
		function (row, col) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				'E',
				A3(_tortus$elm_array_2d$Array2D$get, row, col, stringBoard));
		});
	var getAround = F3(
		function (row, col, offset) {
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: A2(getPiece, row - offset, col + offset),
					_1: A2(getPiece, row + offset, col - offset)
				},
				_1: {
					ctor: '_Tuple2',
					_0: A2(getPiece, row - offset, col - offset),
	...
	var getLines = F3(
		function (row, col, piece) {
			return _elm_lang$core$Native_Utils.eq(piece, 'x') ? '-' : A2(
				_elm_lang$core$String$join,
				'-',
				A2(
					concatLines,
					...
					_elm_lang$core$List$unzip(
						A2(
							_elm_lang$core$List$map,
							A2(getAround, row, col),
							A2(_elm_lang$core$List$range, 1, 4)))));
		});
	return _user$project$Main$getHorizonLines(
		A2(_tortus$elm_array_2d$Array2D$indexedMap, getLines, stringBoard));
};
var _user$project$Main$isNextBlackTurn = function (model) {
	return _elm_lang$core$Native_Utils.eq(
		A2(_elm_lang$core$Basics_ops['%'], model.playBackStep, 2),
		0);
};
var _user$project$Main$isPlayBackMode = function (model) {
	return !_elm_lang$core$Native_Utils.eq(
		model.playBackStep,
		_elm_lang$core$List$length(model.record));
};
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {board: a, record: b, playBackStep: c, result: d};
	});
var _user$project$Main$Empty = {ctor: 'Empty'};
var _user$project$Main$initBoard = A3(_tortus$elm_array_2d$Array2D$repeat, 15, 15, _user$project$Main$Empty);
var _user$project$Main$White = {ctor: 'White'};
var _user$project$Main$Black = {ctor: 'Black'};
var _user$project$Main$Continue = {ctor: 'Continue'};
var _user$project$Main$initModel = {
	board: _user$project$Main$initBoard,
	record: {ctor: '[]'},
	playBackStep: 0,
	result: _user$project$Main$Continue
};
var _user$project$Main$Draw = {ctor: 'Draw'};
var _user$project$Main$WhiteWin = {ctor: 'WhiteWin'};
var _user$project$Main$BlackWin = {ctor: 'BlackWin'};
var _user$project$Main$checkMatchResult = function (board) {
	var whiteWinPattern = _elm_lang$core$Regex$regex('w{5}');
	var blackWinPattern = _elm_lang$core$Regex$regex('b{5}');
	...
	var stringBoard = A2(_tortus$elm_array_2d$Array2D$map, pieceToString, board);
	var lines = A2(
		_elm_lang$core$String$join,
		'-',
		_elm_lang$core$Array$toList(
			A2(
				_elm_lang$core$Array$append,
				_user$project$Main$getDiagonalLines(stringBoard),
				A2(
					_elm_lang$core$Array$append,
					_user$project$Main$getVerticalLines(stringBoard),
					_user$project$Main$getHorizonLines(stringBoard)))));
	return A2(_elm_lang$core$Regex$contains, blackWinPattern, lines) ? _user$project$Main$BlackWin : (A2(_elm_lang$core$Regex$contains, whiteWinPattern, lines) ? _user$project$Main$WhiteWin : ((!A2(_elm_lang$core$String$contains, 'x', lines)) ? _user$project$Main$Draw : _user$project$Main$Continue));
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'Place':
				var piece = _user$project$Main$isNextBlackTurn(model) ? _user$project$Main$Black : _user$project$Main$White;
				var _p6 = model;
				var playBackStep = _p6.playBackStep;
				var record = _p6.record;
				var board = _p6.board;
				var newBoard = A4(_tortus$elm_array_2d$Array2D$set, _p5._0, _p5._1, piece, board);
				var recordCount = _elm_lang$core$List$length(record);
				return (!_elm_lang$core$Native_Utils.eq(model.result, _user$project$Main$Continue)) ? model : (_user$project$Main$isPlayBackMode(model) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						board: newBoard,
						record: {
							ctor: '::',
							_0: newBoard,
							_1: A2(_elm_lang$core$List$drop, recordCount - playBackStep, record)
						},
						playBackStep: 1 + playBackStep,
						result: _user$project$Main$checkMatchResult(newBoard)
					}) : _elm_lang$core$Native_Utils.update(
					model,
					{
						board: newBoard,
						record: {ctor: '::', _0: newBoard, _1: record},
						playBackStep: 1 + recordCount,
						result: _user$project$Main$checkMatchResult(newBoard)
					}));
			case 'Undo':
				var _p7 = model.record;
				if (_p7.ctor === '[]') {
					return model;
				} else {
					var _p8 = _p7._1;
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							record: _p8,
							playBackStep: _elm_lang$core$List$length(_p8),
							result: _user$project$Main$Continue
						});
				}
			case 'PlayBack':
				var recordCount = _elm_lang$core$List$length(model.record);
				var playBackStep = A2(
				...
				var board = A2(
					...
					_elm_lang$core$List$head(
						A2(_elm_lang$core$List$drop, recordCount - playBackStep, model.record)));
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						playBackStep: playBackStep,
						board: board,
						result: _elm_lang$core$Native_Utils.eq(playBackStep, recordCount) ? _user$project$Main$checkMatchResult(board) : _user$project$Main$Continue
					});
			case 'NewGame':
...
var _user$project$Main$PlayBack = function (a) {
...
var _user$project$Main$viewSidebar = function (model) {
	var recordValue = _elm_lang$core$Basics$toString(model.playBackStep);
	var recordCount = _elm_lang$core$Basics$toString(
		_elm_lang$core$List$length(model.record));
	var turn = _user$project$Main$isNextBlackTurn(model) ? 'Black' : 'White';
	var title = function () {
		var _p9 = model.result;
		switch (_p9.ctor) {
			case 'BlackWin':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Black Win!'),
						_1: {ctor: '[]'}
					});
			case 'WhiteWin':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('White Win!'),
						_1: {ctor: '[]'}
					});
			case 'Draw':
				return A2(
			...
			default:
				return _elm_lang$html$Html$text(
					A2(_elm_lang$core$Basics_ops['++'], 'Turn: ', turn));
		}
	}();
	return A2(
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Move ', recordValue)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$max(recordCount),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(recordValue),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$PlayBack),
													_1: {ctor: '[]'}
												}
											}
										}
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_0: _elm_lang$html$Html_Attributes$disabled(
											_user$project$Main$isPlayBackMode(model)),
										_1: {
											ctor: '::',
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('new-game'),
											_1: {
												ctor: '::',
...
var _user$project$Main$viewPiece = F3(
	function (row, column, piece) {
		var attrs = function () {
			var _p10 = piece;
			switch (_p10.ctor) {
				case 'Black':
					return {ctor: '_Tuple2', _0: 'piece black', _1: _user$project$Main$NoOp};
				case 'White':
					return {ctor: '_Tuple2', _0: 'piece white', _1: _user$project$Main$NoOp};
				default:
					return {
						ctor: '_Tuple2',
						_0: 'piece empty',
						_1: A2(_user$project$Main$Place, row, column)
					};
			}
		}();
		return A2(
				...
				_0: A2(
					_elm_lang$html$Html$span,
					{
						...
						_0: _elm_lang$html$Html_Attributes$class(
							_elm_lang$core$Tuple$first(attrs)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_elm_lang$core$Tuple$second(attrs)),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
		...
		return A2(
			...
			_elm_lang$core$Array$toList(
				A2(
					...
					_elm_lang$core$Array$empty,
					A2(
						_tortus$elm_array_2d$Array2D$getRow,
						index,
						A2(_tortus$elm_array_2d$Array2D$indexedMap, _user$project$Main$viewPiece, board)))));
	};
	return A2(
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Array$toList(
						A2(
							_elm_lang$core$Array$initialize,
							_tortus$elm_array_2d$Array2D$rows(board),
							_elm_lang$core$Basics$identity))))));
};
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'mode-playback',
							_1: _user$project$Main$isPlayBackMode(model)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'game-over',
								_1: !_elm_lang$core$Native_Utils.eq(model.result, _user$project$Main$Continue)
							},
							_1: {ctor: '[]'}
						}
					}
